...
class Usuario:
    ...
    def _validate_business_rules(self):
        ...
        if len(self.nome) > 255:
            raise BusinessRuleViolationError("Nome do usuário não pode ter mais de 255 caracteres")
        ...
        if len(self.email) > 255:
            raise BusinessRuleViolationError("Email do usuário não pode ter mais de 255 caracteres")
    ...
    def vincular_prefeitura(self, prefeitura_id: PrefeituraId) -> None:
        ...
        if not isinstance(prefeitura_id, PrefeituraId):
            raise BusinessRuleViolationError("ID da prefeitura deve ser um PrefeituraId válido")
    ...
    def atualizar_email(self, novo_email: str) -> None:
        ...
        if len(novo_email) > 255:
            raise BusinessRuleViolationError("Novo email não pode ter mais de 255 caracteres")
    ...
    def atualizar_nome(self, novo_nome: str) -> None:
        ...
        if len(novo_nome) > 255:
            raise BusinessRuleViolationError("Novo nome não pode ter mais de 255 caracteres")
