...
async def get_prefeitura(
    ...
    try:
        prefeitura = await prefeitura_repo.find_by_id(PrefeituraId.from_uuid(prefeitura_id))
...
async def create_usuario(
    ...
    try:
        prefeitura_id_obj = PrefeituraId.from_uuid(prefeitura_id) if prefeitura_id else None
        usuario = Usuario.create(nome=nome, email=email, prefeitura_id=prefeitura_id_obj)
        ...
        return {
            ...
            "nome": usuario.nome,
            "email": usuario.email,
            "prefeitura_id": str(usuario.prefeitura_id) if usuario.prefeitura_id else None,
