...
from domain.exceptions.chat_exceptions import ChatError, LLMError
...
class ChatWithDocumentsUseCase:
    ...
    async def execute(self, request: ChatRequestDTO) -> ChatResponseDTO:
        ...
        try:
            ...
            query_embedding_vector = await self._llm_service.generate_embedding(request.message)
            ...
            document_references = self._search_service.convert_results_to_references(search_results)
