...
class TestRedisSessionRepository:
    ...
    async def test_save_session_success(
        self, repository, mock_redis_client, sample_chat_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_session_redis_error(
        self, repository, mock_redis_client, sample_chat_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_session_by_id_found(
        self, repository, mock_redis_client, sample_chat_session
    ):
        session_data = {
        ...
        mock_redis_client.get_json.assert_called_once_with(
            f"session:{sample_chat_session.id}"
        )
    ...
    @pytest.mark.asyncio
    async def test_find_session_by_id_redis_error_handled(
        self, repository, mock_redis_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_active_sessions_success(
        self, repository, mock_redis_client, sample_chat_session
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_session_by_id_redis_error_handled_duplicate(
        self, repository, mock_redis_client
    ):
        mock_redis_client.get_json.side_effect = Exception("Redis connection error")
        # O método captura a exceção e retorna None
    ...
    @pytest.mark.asyncio
    async def test_delete_session_success_duplicate(
        self, repository, mock_redis_client
    ):
        session_id = uuid4()
    ...
    @pytest.mark.asyncio
    async def test_delete_session_not_found_duplicate(
        self, repository, mock_redis_client
    ):
        session_id = uuid4()
...
class TestRedisMessageRepository:
    ...
    async def test_save_message_success(
        self, repository, mock_redis_client, sample_message
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_message_redis_error(
        self, repository, mock_redis_client, sample_message
    ):
    ...
    @pytest.mark.asyncio
    async def test_find_messages_by_session_id_success(
        self, repository, mock_redis_client, sample_message
    ):
        session_id = uuid4()
        message_data = {
    ...
    @pytest.mark.asyncio
    async def test_find_messages_by_session_id_empty(
        self, repository, mock_redis_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_delete_messages_by_session_id_success(
        self, repository, mock_redis_client
    ):
        session_id = uuid4()
    ...
    @pytest.mark.asyncio
    async def test_delete_messages_by_session_id_no_messages(
        self, repository, mock_redis_client
    ):
        session_id = uuid4()
    ...
    @pytest.mark.asyncio
    async def test_count_messages_by_session_id_success(
        self, repository, mock_redis_client
    ):
        session_id = uuid4()
    ...
    @pytest.mark.asyncio
    async def test_count_messages_by_session_id_empty(
        self, repository, mock_redis_client
    ):
        session_id = uuid4()
        mock_redis_client.list_length.return_value = 0
