...
from application.dto.document_dto import PresignedUploadRequestDTO, PresignedUploadResponseDTO
...
class TestCreatePresignedUploadUseCase:
    ...
    async def test_execute_s3_service_error(
        ...
        mock_s3_service.generate_presigned_upload_url.side_effect = Exception("S3 error")
        mock_file_upload_repository.save = AsyncMock()
        
        with pytest.raises(BusinessRuleViolationError, match="Falha na criação do upload"):
    ...
    def test_validate_request_empty_filename(self, use_case):
        ...
        with pytest.raises(BusinessRuleViolationError, match="Nome do arquivo é obrigatório"):
    ...
    def test_validate_request_zero_file_size(self, use_case):
        ...
        with pytest.raises(BusinessRuleViolationError, match="Tamanho do arquivo deve ser maior que zero"):
            use_case._validate_request(request)
    ...
    def test_validate_request_file_too_large(self, use_case):
        ...
        with pytest.raises(BusinessRuleViolationError, match="Arquivo não pode ser maior que 5GB"):
            use_case._validate_request(request)
    ...
    def test_validate_request_unsupported_extension(self, use_case):
        ...
        with pytest.raises(BusinessRuleViolationError, match="Extensão de arquivo não suportada"):
            use_case._validate_request(request)
    ...
    def test_validate_request_title_too_long(self, use_case):
        ...
        with pytest.raises(BusinessRuleViolationError, match="Título não pode ter mais de 255 caracteres"):
            use_case._validate_request(request)
    ...
    def test_validate_request_description_too_long(self, use_case):
        ...
        with pytest.raises(BusinessRuleViolationError, match="Descrição não pode ter mais de 1000 caracteres"):
            use_case._validate_request(request)
    ...
    def test_validate_request_too_many_tags(self, use_case):
        ...
        with pytest.raises(BusinessRuleViolationError, match="Máximo de 10 tags permitidas"):
            use_case._validate_request(request)
    ...
    def test_validate_request_tag_too_long(self, use_case):
        ...
        with pytest.raises(BusinessRuleViolationError, match="Tags não podem ter mais de 50 caracteres"):
            use_case._validate_request(request)
