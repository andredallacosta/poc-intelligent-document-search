...
class TestChatWithDocumentsUseCase:
    ...
    async def test_execute_new_session_success(
        ...
        mock_llm_service.generate_embedding.assert_called_once_with(chat_request_new_session.message)
    ...
    async def test_execute_existing_session_success(
        ...
        mock_chat_service.add_user_message = AsyncMock(return_value=mock_user_message)
        mock_chat_service.add_assistant_message = AsyncMock(return_value=mock_assistant_message)
        mock_chat_service.get_conversation_history = AsyncMock(return_value=[mock_user_message])
    ...
    async def test_execute_llm_context_preparation(
        ...
        mock_chat_service.add_user_message = AsyncMock(return_value=mock_user_message)
        mock_chat_service.add_assistant_message = AsyncMock(return_value=mock_assistant_message)
        mock_chat_service.get_conversation_history = AsyncMock(return_value=conversation_history)
