...
class TestDocumentMetadata:
    def test_create_minimal_metadata(self):
        metadata = DocumentMetadata(source="test.pdf", file_size=1024, file_type="pdf")
    ...
    def test_is_pdf_property(self):
        pdf_metadata = DocumentMetadata(
            source="test.pdf", file_size=1024, file_type="PDF"
        )
        non_pdf_metadata = DocumentMetadata(
            source="test.docx", file_size=1024, file_type="docx"
        )
    ...
    def test_is_docx_property(self):
        ...
        doc_metadata = DocumentMetadata(
            source="test.doc", file_size=1024, file_type="doc"
        )
        pdf_metadata = DocumentMetadata(
            source="test.pdf", file_size=1024, file_type="pdf"
        )
    ...
    def test_is_web_content_property(self):
        html_metadata = DocumentMetadata(
            source="webpage.html", file_size=1024, file_type="HTML"
        )
        pdf_metadata = DocumentMetadata(
            source="test.pdf", file_size=1024, file_type="pdf"
        )
    ...
    def test_size_mb_property(self):
        metadata = DocumentMetadata(
            source="test.pdf", file_size=1024 * 1024, file_type="pdf"
        )
        assert metadata.size_mb == 1.0
        small_metadata = DocumentMetadata(
            source="small.txt", file_size=512 * 1024, file_type="txt"
        )
    ...
    def test_metadata_hash(self):
        metadata1 = DocumentMetadata(source="test.pdf", file_size=1024, file_type="pdf")
        metadata2 = DocumentMetadata(source="test.pdf", file_size=1024, file_type="pdf")
