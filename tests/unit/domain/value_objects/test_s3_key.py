...
class TestS3Key:
    ...
    def test_bucket_too_long(self):
        long_bucket = "a" * 64
        with pytest.raises(BusinessRuleViolationError, match="Bucket S3 não pode ter mais de 63 caracteres"):
    ...
    def test_key_too_long(self):
        long_key = "a" * 1025
        with pytest.raises(BusinessRuleViolationError, match="Key S3 não pode ter mais de 1024 caracteres"):
    ...
    def test_url_property_other_region(self):
        ...
        assert s3_key.url == "https://test-bucket.s3.us-west-2.amazonaws.com/test/file.pdf"
