...
class RedisSessionRepository(SessionRepository):
    ...
    async def save_session(self, session: ChatSession) -> ChatSession:
        try:
            ...
            await self._redis_client.set_json(key, session_data, expire=self._session_ttl)
...
class RedisMessageRepository(MessageRepository):
    ...
    async def save_message(self, message: Message) -> Message:
        try:
            ...
            await self._redis_client.expire(session_key, self._message_ttl.total_seconds())
