...
class ContextGenerator:
    ...
    def __init__(self):
        self.content_patterns = {
            ...
            'financial': ['receita', 'despesa', 'orçamento', 'valor', 'custo', 'preço', 'proposta'],
            'administrative': ['ofício', 'memorando', 'circular', 'portaria', 'município', 'presidente', 'câmara', 'vereador', 'prefeito'],
    ...
    def generate_context(self, chunk: str, metadata: Dict[str, Any], position_info: Dict[str, Any]) -> str:
        context_parts = []
    ...
    def _get_section_context(self, chunk: str, position_info: Dict[str, Any]) -> Optional[str]:
    ...
    def extract_document_metadata(self, full_text: str, file_metadata: Dict[str, Any]) -> Dict[str, Any]:
